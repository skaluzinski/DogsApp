...
class GetRandomQuoteUseCase @Inject constructor(private val quotesRemoteDataSource: QuotesRemoteDataSource):IGetRandomQuoteUseCase {
    override suspend fun execute(): Flow<QuoteResponse> = flow{
        emit(quotesRemoteDataSource.getRandomQuote())
    }
}